...
const createNotificationItemNode = notification => {
    ...
    const dateNode = createNode('div', ['pupi_fns_notification-item-date'], headerNode);
    dateNode.innerText = notification.created_at; // e.g. "5 days ago" or full date depending on Admin option
    dateNode.title = notification.created_at_full; // full ISO date as tooltip on hover
